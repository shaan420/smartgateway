...
int main(int argc, char *argv[])
{
	...
	if(curl) {
		...
		//curl_easy_setopt(curl, CURLOPT_URL, "http://192.168.0.33:8080/executeCommand");
		curl_easy_setopt(curl, CURLOPT_URL, "http://10.218.100.213:8080/executeCommand");
		...
		curl_easy_setopt(curl, CURLOPT_POSTFIELDS, "DevRef=X&DeviceClass=Device&hasLocation=Bedroom&causes=Light\nDeviceName=<X>&set_status=0");
