...
#ifndef __dbus_glib_marshal_contextManager_object_MARSHAL_H__
#define __dbus_glib_marshal_contextManager_object_MARSHAL_H__
...
extern void dbus_glib_marshal_contextManager_object_BOOLEAN__STRING_STRING_POINTER_POINTER (GClosure     *closure,
                                                                                            GValue       *return_value,
...
void
dbus_glib_marshal_contextManager_object_BOOLEAN__STRING_STRING_POINTER_POINTER (GClosure     *closure,
...
extern void dbus_glib_marshal_contextManager_object_BOOLEAN__STRING_POINTER_POINTER (GClosure     *closure,
                                                                                     GValue       *return_value,
                                                                                     guint         n_param_values,
                                                                                     const GValue *param_values,
                                                                                     gpointer      invocation_hint,
                                                                                     gpointer      marshal_data);
void
dbus_glib_marshal_contextManager_object_BOOLEAN__STRING_POINTER_POINTER (GClosure     *closure,
                                                                         GValue       *return_value G_GNUC_UNUSED,
                                                                         guint         n_param_values,
                                                                         const GValue *param_values,
                                                                         gpointer      invocation_hint G_GNUC_UNUSED,
...
#endif /* __dbus_glib_marshal_contextManager_object_MARSHAL_H__ */
