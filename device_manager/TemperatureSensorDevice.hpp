#ifndef __TEMPERATURE_SENSOR_DEVICE_HPP__
#define __TEMPERATURE_SENSOR_DEVICE_HPP__
...
class TemperatureSensorDevice : public DeviceDbus<TemperatureSensorObject>
{
	protected:
	...
	public:
		TemperatureSensorDevice(const string name, const string desc, DeviceConf_t conf) 
				: DeviceDbus(TEMPERATURESENSOR_TYPE_OBJECT, name, desc, conf)
		{ 
		}
