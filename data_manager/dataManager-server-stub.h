...
#ifndef __dbus_glib_marshal_dataManager_object_MARSHAL_H__
#define __dbus_glib_marshal_dataManager_object_MARSHAL_H__
...
/* BOOLEAN:STRING,STRING,INT,POINTER,POINTER,POINTER */
extern void dbus_glib_marshal_dataManager_object_BOOLEAN__STRING_STRING_INT_POINTER_POINTER_POINTER (GClosure     *closure,
                                                                                                     GValue       *return_value,
...
void
dbus_glib_marshal_dataManager_object_BOOLEAN__STRING_STRING_INT_POINTER_POINTER_POINTER (GClosure     *closure,
                                                                                         ...
                                                                                         gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__STRING_STRING_INT_POINTER_POINTER_POINTER) (gpointer     data1,
                                                                                       gpointer     arg_1,
                                                                                       gpointer     arg_2,
                                                                                       gint         arg_3,
                                                                                       gpointer     arg_4,
                                                                                       ...
                                                                                       gpointer     arg_6,
                                                                                       gpointer     data2);
  register GMarshalFunc_BOOLEAN__STRING_STRING_INT_POINTER_POINTER_POINTER callback;
  ...
  callback = (GMarshalFunc_BOOLEAN__STRING_STRING_INT_POINTER_POINTER_POINTER) (marshal_data ? marshal_data : cc->callback);
...
extern void dbus_glib_marshal_dataManager_object_BOOLEAN__STRING_POINTER (GClosure     *closure,
                                                                          GValue       *return_value,
                                                                          guint         n_param_values,
                                                                          const GValue *param_values,
                                                                          gpointer      invocation_hint,
                                                                          gpointer      marshal_data);
void
dbus_glib_marshal_dataManager_object_BOOLEAN__STRING_POINTER (GClosure     *closure,
                                                              GValue       *return_value G_GNUC_UNUSED,
                                                              guint         n_param_values,
                                                              const GValue *param_values,
                                                              gpointer      invocation_hint G_GNUC_UNUSED,
